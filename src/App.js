...
import { WsrCarousel, WsrMainMenu, WsrBlockTitle, WsrBlock, WsrBlockBlank, WsrNewsItem, WsrNumbersItem, WsrFooter,} from "./wsr-components.js";
...
На международном чемпионата China International Skills Competition 2017 (CISC-2017)"
                    ...
                    <WsrBlock type="wsr-block-announce" heading="Обучение в Академии WorldSkills на базе СЦК по компетенции «Электромонтаж»" description="21 августа 2017 года в Колледже архитектуры дизайна и реинжиниринга №26 на базе СЦК по компетенции «Электромонтаж» стартует обучение по программе Академии WorldSkills Russia «Практика и методика подготовки кадров с учетом стандартов Ворлдскиллс Россия»."
                      date="10.05.2017" image="/Images/thumb07.jpg" link="/announce"/>
