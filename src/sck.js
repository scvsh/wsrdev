...
import { WsrSckSearch, WsrExpertSearch, WsrSckInfo, WsrExpert, WsrBlock, WsrCarousel, WsrMainMenu, WsrBlockTitle, WsrBlockBlank, WsrFooter } from "./wsr-components.js";
            ...
            <div className="App">
             ...
             <Grid bsClass="containter-fluid">
                ...
                <Col sm={ 9 } md={9} lg={10} smHidden mdHidden lgHidden className="full-size">
                    <WsrSckSearch categories={ ["Все компетенции", "Кузовной ремонт", "Столярное дело", "Программные решения для бизнеса", "Видеопроизводство", "Предпринимательство", "Администрирование отеля", "Спасательные работы", "Малярные и декоративные работы", "Облицовка плиткой"] } scks={ ["ГБПОУ КАТ № 9", "..."] } />
                  </Col>
